  ...
  return (
    <div className='p-10 mt-10'>
        <div className=' flex gap-10 '>
         ...
         <div className='p-2 h-[34rem]  w-[80%] text-7xl font-bold'>
            <div>EYE-</div>
            <div>OPENING</div>
         </div>
         
         <div className=' w-full relative pl-4 '>
           <div><div className='text-7xl font-bold pt-4 pb-10'>PRESENTATIONS</div></div>
           <div className='pb-5'><ul> <li className='pb-5'>S:</li><li>Instagram</li><li>Behance</li><li>Facebook</li><li>Linkedin</li></ul></div>
           <div className='pb-5'><ul> <li className='pb-5'>L:</li><li>202-1965 W 4th Ave</li><li className='pb-4'>Vancouver, Canada</li><li>30 Chukarina St</li><li>Lviv, Ukraine</li></ul></div>
           <div className=''><ul> <li className='pb-5'>E:</li><li>hello@ochi.design</li></ul></div>
           <div className='absolute right-20 bottom-24'><ul> <li>M:</li><li>Home</li><li>Services</li><li>Our work</li><li>About us</li><li>Insight</li><li>Contact Us</li></ul></div>
         </div>
          
        </div>
        <div className='  w-full h-16  flex mt-10'>
            <div className='w-[30rem]'><svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='pl-48'>© ochi design 2024. <a href="#">Legal Teams</a></div>
            <div className='pl-[26rem]'><a href="#">Website by Obys</a></div>
         </div>
    </div>
  )
}
